...
?>
<ul class="headNote">
	Los siguientes graficos aplican unicamente a ambientes Windows. En caso que el dato buscado no se encuentre o sea insuficiente se sugiere utilizar la función especifica fuera del dashboard.
</ul>
<ul id="myDashboard" class="myDashboard"></ul>

<?php 
	$i=new images_ConsumeHistoricAllDaily();
	$params=array('name' => 'images_ConsumeHistoricAllDaily_24h', 'policy' => 'win', 'timeago' => '24 Hour', 'type' => 'hour',4);
	...
	$params=array('name' => 'images_ConsumeHistoricAllDaily_7d', 'policy' => 'win', 'timeago' => '7 Day', 'type' => 'day',4);
		$i->images_ConsumeHistoricAllDaily__params($params);
		$i->images_ConsumeHistoricAllDaily__data($params);
		$i->images_ConsumeHistoricAllDaily__js($params);
	$params=array('name' => 'images_ConsumeHistoricAllDaily_14d', 'policy' => 'win', 'timeago' => '14 Day', 'type' => 'day',4);
		$i->images_ConsumeHistoricAllDaily__params($params);
		$i->images_ConsumeHistoricAllDaily__data($params);
		$i->images_ConsumeHistoricAllDaily__js($params);
?>
			...
			$(function() {
				...
				var dashboardJSON = [{
					...
					$p = new policy_active_ds();  //dashboard policy active/inactive
						$params=array('name' => 'policy_active_ds', 'policy' => 'win', 2);
					...
					$e = new errors_StatusLike_ds; // % of return status like code - multiple params possible
						$params=array('name' => 'errors_statuslike_ds_24h', 'policy' => 'win', 'timeago' => '24 Hour', 3);
					...
					<?php
					$e = new errors_StatusLike_ds; // % of return status like code - multiple params possible
						$params=array('name' => 'errors_StatusLike_ds_7d', 'policy' => 'win', 'timeago' => '7 Day', 3);
						$e->errors_StatusLike_ds__data($params);
						$e->errors_StatusLike_ds__graph($params);
					?>
				}, {
					<?php
					$e = new errors_StatusLike_ds; // % of return status like code - multiple params possible
						$params=array('name' => 'errors_StatusLike_ds_14d', 'policy' => 'win', 'timeago' => '14 Day', 3);
						$e->errors_StatusLike_ds__data($params);
						$e->errors_StatusLike_ds__graph($params);
					?>
				}, {
					...
					$e = new errors_StatusLikeDefined_ds(); // % of return status like code not 0 - multiple params possible
						$params=array('name' => 'errors_StatusLikeDefined_ds_24h', 'policy' => 'win', 'timeago' => '24 Hour', 3);
					...
					<?php 
					$e = new errors_StatusLikeDefined_ds(); // % of return status like code not 0 - multiple params possible
						$params=array('name' => 'errors_StatusLikeDefined_ds_7d', 'policy' => 'win', 'timeago' => '7 Day', 3);
						$e->errors_StatusLikeDefined_ds__data($params);
						$e->errors_StatusLikeDefined_ds__graph($params);
					?>
				}, {
					<?php 
					$e = new errors_StatusLikeDefined_ds(); // % of return status like code not 0 - multiple params possible
						$params=array('name' => 'errors_StatusLikeDefined_ds_14d', 'policy' => 'win', 'timeago' => '14 Day', 3);
						$e->errors_StatusLikeDefined_ds__data($params);
						$e->errors_StatusLikeDefined_ds__graph($params);
					?>
				}, {	
					...
					$e = new errors_FailedList_ds(); // List of return status not 0 - multiple params possible
						$params=array('name' => 'errors_FailedList_ds_24h', 'policy' => 'win', 'timeago' => '24 Hour', 3);
					...
					<?php 
					$e = new errors_FailedList_ds(); // List of return status not 0 - multiple params possible
						$params=array('name' => 'errors_FailedList_ds_7d', 'policy' => 'win', 'timeago' => '7 Day', 3);
						$e->errors_FailedList_ds__data($params);
						$e->errors_FailedList_ds__table($params);
					?>
				}, {
					<?php 
					$e = new errors_FailedList_ds(); // List of return status not 0 - multiple params possible
						$params=array('name' => 'errors_FailedList_ds_14d', 'policy' => 'win', 'timeago' => '14 Day', 3);
						$e->errors_FailedList_ds__data($params);
						$e->errors_FailedList_ds__table($params);
					?>
				}, {
					...
					$i = new images_RetentionLevelList_ds(); // List of retention level - multiple params possible
						$params=array('name' => 'images_RetentionLevelList_ds_24h', 'policy' => 'win', 'timeago' => '24 Hour', 3);
					...
					<?php 
					$i = new images_RetentionLevelList_ds(); // List of retention level - multiple params possible
						$params=array('name' => 'images_RetentionLevelList_ds_7d', 'policy' => 'win', 'timeago' => '7 Day', 3);
						$i->images_RetentionLevelList_ds__data($params);
						$i->images_RetentionLevelList_ds__graph($params);
					?>
				}, {
					<?php 
					$i = new images_RetentionLevelList_ds(); // List of retention level - multiple params possible
						$params=array('name' => 'images_RetentionLevelList_ds_14d', 'policy' => 'win', 'timeago' => '14 Day', 3);
						$i->images_RetentionLevelList_ds__data($params);
						$i->images_RetentionLevelList_ds__graph($params);
					?>
				}, {
					...
					$i = new images_ClientImageInImages_ds(); //List of clients in images - multiple params possible
						$params=array('name' => 'images_ClientImageInImages_ds_24h', 'client' => 'win', 'timeago' => '24 Hour', 3);
					...
					$i = new images_ConsumeClientList_ds(); //List consume of clients - multiple params possible
						$params=array('name' => 'images_ConsumeClientList_ds_24h', 'policy' => 'win', 'timeago' => '24 Hour', 3);
					...
					<?php 
					$i = new images_ConsumeClientList_ds(); //List consume of clients - multiple params possible
						$params=array('name' => 'images_ConsumeClientList_ds_7d', 'policy' => 'win', 'timeago' => '7 Day', 3);
						$i->images_ConsumeClientList_ds__data($params);
						$i->images_ConsumeClientList_ds__table($params);
					?>
				}, {
					<?php 
					$i = new images_ConsumeClientList_ds(); //List consume of clients - multiple params possible
						$params=array('name' => 'images_ConsumeClientList_ds_14d', 'policy' => 'win', 'timeago' => '14 Day', 3);
						$i->images_ConsumeClientList_ds__data($params);
						$i->images_ConsumeClientList_ds__table($params);
					?>
				}, {
					...
					$i = new images_ConsumePolicyList_ds();
						$params=array('name' => 'images_ConsumePolicyList_ds_24h', 'policy' => 'win', 'timeago' => '24 Hour', 3);
					...
					<?php 
					$i = new images_ConsumePolicyList_ds();
						$params=array('name' => 'images_ConsumePolicyList_ds_7d', 'policy' => 'win', 'timeago' => '7 Day', 3);
						$i->images_ConsumePolicyList_ds__data($params);
						$i->images_ConsumePolicyList_ds__table($params);
					?>
				}, {
					<?php 
					$i = new images_ConsumePolicyList_ds();
						$params=array('name' => 'images_ConsumePolicyList_ds_14d', 'policy' => 'win', 'timeago' => '14 Day', 3);
						$i->images_ConsumePolicyList_ds__data($params);
						$i->images_ConsumePolicyList_ds__table($params);
					?>
				}, {
					...
					$i = new images_ListGroupHour_ds();
						$params=array('name' => 'images_ListGroupHour_ds_24h', 'policy' => 'win', 'timeago' => '24 Hour', 3);
					...
					<?php 
					$i = new images_ListGroupHour_ds();
						$params=array('name' => 'images_ListGroupHour_ds_7d', 'policy' => 'win', 'timeago' => '7 Day', 3);
						$i->images_ListGroupHour_ds__data($params);
						$i->images_ListGroupHour_ds__table($params);
					?>
				}, {
					<?php 
					$i = new images_ListGroupHour_ds();
						$params=array('name' => 'images_ListGroupHour_ds_14d', 'policy' => 'win', 'timeago' => '14 Day', 3);
						$i->images_ListGroupHour_ds__data($params);
						$i->images_ListGroupHour_ds__table($params);
					?>
				}, {
					...
					$i = new images_PolicyLikeList_ds(); //List consume by Policy like pie - multiple params possible
						$params=array('name' => 'images_PolicyLikeList_ds_24h', 'policy' => 'win', 'timeago' => '24 Hour', 3);
					...
					<?php
					$i = new images_PolicyLikeList_ds(); //List consume by Policy like pie - multiple params possible
						$params=array('name' => 'images_PolicyLikeList_ds_7d', 'policy' => 'win', 'timeago' => '7 Day', 3);
						$i->images_ClientLikeList_ds__data($params);
						$i->images_ClientLikeList_ds__graph($params);
					?>
				}, {
					<?php
					$i = new images_PolicyLikeList_ds(); //List consume by Policy like pie - multiple params possible
						$params=array('name' => 'images_PolicyLikeList_ds_14d', 'policy' => 'win', 'timeago' => '14 Day', 3);
						$i->images_ClientLikeList_ds__data($params);
						$i->images_ClientLikeList_ds__graph($params);
					?>
				}, {
					...
					$i=new images_PolicyListInImages_ds();
						$params=array('name' => 'images_PolicyListInImages_ds_24h', 'policy' => 'win', 'timeago' => '24 Hour',3);
					...
					<?php 
					$i=new images_PolicyListInImages_ds();
						$params=array('name' => 'images_PolicyListInImages_ds_7d', 'policy' => 'win', 'timeago' => '7 Day',3);
						$i->images_PolicyListInImages_ds__data($params);
						$i->images_PolicyListInImages_ds__graph($params);
					?>
				}];
